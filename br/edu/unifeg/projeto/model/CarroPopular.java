...
public class CarroPopular extends Aluguel{
    ...
    public CarroPopular(String nome, int idade, Boolean cnhValida, int tempoHabilitado, int diasAlugados, Double valorDiario,
    ...
    @Override
    public void seguro(){
        System.out.println(" --- SEGURO DO VEÍCULO POPULAR --- ");
